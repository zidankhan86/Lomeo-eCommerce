                    ...
                    <div class="">
                        <div class="p-6">
                            ...
                            <div class="pb-[26px] mx-auto">
                                <img class="w-[150px] h-[150px] rounded-full mx-auto object-cover" src="{{ url('/public/uploads/',auth()->user()->image) }}" alt="image description" id="blah">
                            </div>


                            <form action="{{ route('account.image',auth()->user()->id) }}" method="POST" enctype="multipart/form-data" id="upload-form">
                                @csrf
