                        ...
                        <div class="flex justify-between items-end">
                            <div class="flex items-center flex-wrap gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-[#9A9CAA] lg:text-[16px] lg:leading-[140%] text-sm font-normal font-display">Fashion Designer</p>
                                </div>
                            </div>
                ...
                <div class="swiper-slide">
                    ...
                    <div class="testimonial-card bg-white lg:p-10 sm:p-6 p-4 rounded-xl shadow-[0px_8px_40px_rgba(39,35,67,0.08)]">
                        ...
                        <div class="flex justify-between items-end">
                            <div class="flex items-center flex-wrap gap-3">
                                <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                    <img src="/frontend./public/assets/images/all-img/testimonials.png" alt="" class="w-full h-full rounded-full">
                                </div>
                                <div>
