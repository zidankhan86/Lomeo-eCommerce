                ...
                <div class="swiper-slide">
                    ...
                    <div class="testimonial-card bg-white lg:p-10 sm:p-6 p-4 rounded-xl shadow-[0px_8px_40px_rgba(39,35,67,0.08)]">
                        <div class="shadow-[inset_2px_0px_0px_#029FAE] pl-6">
                            <p class="text-[#636270] font-display font-normal lg:text-[20px] lg:leading-[150%] sm:text-base text-sm capitalize">“{{$comment->description}}“</p>
                        </div>
                        <div class="flex justify-between items-end">
                            <div class="flex items-center flex-wrap gap-3">
                                <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                    <img src="{{url('/public/uploads/',$comment->image)}}" alt="" class="w-full h-full rounded-full">
                                </div>
                                <div>
                                    <h4 class="xl:text-[20px] xl:leading-[140%] text-sm md:text-base text-gray-black capitalize font-medium font-display">{{ $comment->name }}</h4>
                                    <p class="text-[#9A9CAA] lg:text-[16px] lg:leading-[140%] text-sm font-display">{{ $comment->position }}</p>
                                </div>
                            </div>
