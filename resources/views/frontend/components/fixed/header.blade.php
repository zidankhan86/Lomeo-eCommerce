 ...
 <header class="font-display">
                ...
                <div class="flex justify-between items-center py-5">
                    ...
                    <div class="lg:max-w-[413px] lg:block hidden w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search_key" id="search_key" placeholder="search here..." class="block w-full bg-white focus:outline-none border-0 px-4 py-3 rounded-lg focus:ring-2 ring-[#029FAE]">


                            <label for="search" class="absolute right-4 top-3">
                                <button type="submit"> <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="lg:block hidden">
                        <ul class="flex items-center gap-3">
                                        ...
                                        <li class="pb-4">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-1">
                                                    <div>
                                                        <img src="/frontend./public/assets/images/all-img/cart-01.png" alt="">
                                                    </div>
                                                    <div class="px-2">
                            ...
                            <li class="inline-flex items-center justify-center">
                                <a href="{{ route('wishlist.index') }}" class="bg-white text-gray-black hover:text-[#007580] rounded-lg p-[11px]">
    ...
    <div class="nav-menu" id="nav-menu">
        <div class="flex justify-between  items-center px-3 py-4 mb-4">
            <div>
                <a href="#">
                    <img src="/frontend./public/assets/images/all-img/logo-sm.png" alt="">
                </a>
            </div>
            <ul class="flex items-center gap-3">
                <li>
