            ...
            <div class="right-side xl:px-8 px-0 xl:w-5/12 w-full">
                ...
                <div class="flex gap-2.5 items-center">
                    ...
                    <ul class="m-0 p-0 flex gap-1">
                        <li>
                            <a href="{{ route('social.share',$products->id) }}" class="p-[11px] inline-flex justify-center items-center text-[#636270] hover:text-[#029FAE] border hover:border-[#029FAE] border-transparent rounded-full transition-all duration-500">
