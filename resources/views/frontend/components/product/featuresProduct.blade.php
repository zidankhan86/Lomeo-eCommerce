                    ...
                    <div class="product-card">
                        <a href="{{ route('details',$feature->id) }}">
                            ...
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">{{ $feature->name }}</h2>
                                    <h3 class="product-price">BDT {{ $feature->price }}</h3>
                                </div>
                                <div>
                                    <a href="{{ route('cart.add',$feature->id) }}" class="cart-icon">
                        ...
                        @php
                    $isInWishlist = $wishlistItems->contains('product_id', $feature->id);
                    @endphp
                        <form method="POST" action="{{ route('add.to.wishlist',$feature->id, ['productId' => $feature->id]) }}">
                            @csrf
