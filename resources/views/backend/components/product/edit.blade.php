                    ...
                    <div class="row row-cards">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $product->price }}" class="form-control" name="price" placeholder="Price">
                            </div>
                            @error('price')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $product->stock }}" class="form-control" name="stock" placeholder="Stock">
                            </div>
                            @error('stock')
                            <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" value="{{ $product->discount  }}" class="form-control" name="discount" placeholder="Discount">
                            </div>
                            @error('discount')
                            <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea rows="5"  name="long_description" id="editor" class="form-control" placeholder="Product Description">{{ $product->long_description  }}</textarea>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea rows="5"  name="short_description" id="editors" class="form-control" placeholder=" Write something here..">{{ $product->short_description  }}</textarea>
                            </div>
                        </div>
