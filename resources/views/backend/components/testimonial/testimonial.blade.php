...
<br><br><div class="col-10 mx-auto">
    <form class="card" action="{{ route('testimonial.store') }}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('position') }}" name="position" class="form-control" placeholder="Laravel Developer">
                    ...
                    <textarea name="description" id="" cols="100" rows="5" placeholder="Write something"></textarea>
                        </div>
                        @error('category_id')
                <p class="text-danger">{{ $message }}</p>
                  @enderror
